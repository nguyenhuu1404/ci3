...
class image_CRUD {
    ...
    protected function _get_delete_url($value)
    {
    	...
    	if($module){
    		return site_url($module.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/delete_file/'.$value);
    	}else{
	...
	protected function getState()
	{
		...
		if(isset($rsegments_array[3]) && is_numeric($rsegments_array[3]))
		{
			...
			$module = $this->ci->router->module;
			if($module) {
				$upload_url = site_url($module.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/upload_file/'.$rsegments_array[3]);
				$ajax_list_url  = site_url($module.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/'.$rsegments_array[3].'/ajax_list');
				$ordering_url  = site_url($module.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
				$insert_title_url  = site_url($module.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
			}else{
